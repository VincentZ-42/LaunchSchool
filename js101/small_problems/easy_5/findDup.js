...
P - Understand the Problem
  ...
  Output: Number that occurs twice in array
  Rules:
    Only one value will appear twice
    Every other value occurs exactly once.

  Questions:
    What happens if none?
    Is it only integers (floats doubles)?
...
D - Data Structures
    1. Iterate through input array
      ...
      - Search through array with includes
...
function findDup(array) {
  ...
  while (array.length > 1) {
    ...
    if (array.includes(dup)) return dup;
  }
